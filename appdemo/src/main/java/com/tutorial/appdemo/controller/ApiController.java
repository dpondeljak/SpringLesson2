 ...
 * "Gre�ka kod prijave. Provjerite svoje korisnicke podatke" } , "code": 401 }
 * 
 */
...
public class ApiController {
	...
	public String home() {
		...
		/*
		 * npr: { "success": false, "error": {"code": 404, "message": "Gre�ka." } ,
		 * "code": 404 }
		 */
	...
	/**
	 * Generi�ka poruka o gre�ci
	 * 
	 * @return String - Gre�ka i kod
	 */
	private String errorResponse() {
		String tGreska = "{ \"success\": false, \"error\": {\"code\": 404, \"message\": \"Gre�ka.\" },  \"code\": 404 }";
